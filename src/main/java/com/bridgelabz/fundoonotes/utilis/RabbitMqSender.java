 ...
 * 
 * @Value("${fundoo.rabbitmq.exchange}") private String exchange;
 * 
 * @Value("${fundoo.rabbitmq.routingkey}") private String routingkey;
 * 
 * public void send(Object obj) { System.out.println(exchange + "    " +
 * routingkey); System.out.println("Send msg = " + obj.toString());
